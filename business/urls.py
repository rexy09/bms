...
urlpatterns = [
    ...
    path("procurement/management/suppliers/", views.suppliers, name="suppliers"),
    path("procurement/management/suppliers/add/", views.add_supplier, name="add_supplier"),
    ...
    path("financial/statements/", reports.financial_statements, name="financial_statements"),
    path("financial/statements/income/statement/time/", reports.income_statement_time, name="income_statement_time"),
    path("<int:d>/financial/statements/income/statement/", reports.income_statement, name="income_statement"),
    path("financial/statements/balance-sheet/", reports.balance_sheet, name="balance-sheet"),

    path("cashbook/time/", reports.cashflow_time, name="cashflow_time"),
    path("cashbook/", reports.cashflow, name="cashflow"),
    ...
    path("trialbalance/", views.trial_balance, name="trial-balance"),   
    path("trialbalance/time/", reports.trial_balance_time, name="trial-balance-time"),   
    path("trialbalance/excel/", excels.trial_balance_export_excel, name="trial-balance-excel"),   
    path("trialbalance/pdf/", pdfs.trial_balance_export_pdf, name="trial-balance-pdf"),   
    path("balancesheet/pdf/", reports.balance_sheet_export_pdf, name="balance-sheet-pdf"),   

    path("<int:id>/stock/add/", views.add_stock, name="add_stock"),  
    path("get/stock/", views.get_stock, name="get_stock"), 
    path("<int:id>/products/sells/", views.products_sells, name="products_sells"), 
    path("<int:id>/products/price/", views.add_sell_price, name="add_sell_price"), 
    path("<int:id>/reports/stock/", reports.stock_time, name="stock_time"),
    path("<int:id>/<int:d>/reports/stock/report", reports.stock_report, name="stock_report"),

    path("<int:id>/reports/supplier/", reports.supplier_time, name="supplier_time"),
    path("<int:id>/reports/supplier/report/", reports.supplier_report, name="supplier_report"),

    path("<int:id>/grn/", views.goods_received_note, name="goods_received_note"),
    path("<int:id>/grn/add/", views.add_goods_received_note, name="add_goods_received_note"),
    path('<int:id>/ajax/order_no/', views.autocomplete_order_no, name="autocomplete_order_no"),
    path("<int:id>/grn/view/", views.view_goods_received_note, name="view_goods_received_note"),
    path("<int:id>/grn/edit/", views.edit_goods_received_note, name="edit_goods_received_note"),
    path("<int:id>/purchase/ledger/", views.purchase_ledger, name="purchase_ledger"),
    path("<int:id>/purchase/ledger/add/", views.add_purchase_ledger, name="add_purchase_ledger"),
    path("<int:id>/purchase/ledger/edit/", views.edit_purchase_ledger, name="edit_purchase_ledger"),

    path("equity/", views.equity_list, name="equity-list"),       
    path("equity/delete/<int:id>/", views.equity_delete, name="equity-delete"),       

    path("<int:id>/reports/grn/", reports.grn_time, name="grn_time"),
    path("<int:id>/reports/grn/report/", reports.grn_report, name="grn_report"),
]
