...
class Product(models.Model):
	...
	sell_price = models.DecimalField(max_digits=19, decimal_places=2, default=0)
...
class Sale(models.Model):
	...
	business = models.ForeignKey(Business, related_name="sale", on_delete=models.CASCADE)
...
class Expense(models.Model):
	...
	bank = models.ForeignKey(Bank, related_name="bank_expense", on_delete=models.SET_NULL, blank=True, null=True)
...
class Payroll(models.Model):
	...
	heslb_amount = models.PositiveIntegerField(default=0, null=True, blank=0)
	nssf = models.BooleanField(default=False)
	nssf_amount = models.PositiveIntegerField(default=0, null=True, blank=0)
...
class Stock(models.Model):
	...
	business = models.ForeignKey(Business, related_name="stock", on_delete=models.CASCADE)
	product = models.ForeignKey(Product, related_name="product_stock", on_delete=models.CASCADE)
	quantity = models.PositiveIntegerField(default=0)    
	stock_type = models.CharField(max_length=50, choices=TYPE)
...
class GoodsReceivedNote(models.Model):
	business = models.ForeignKey(Business, related_name="grn", on_delete=models.CASCADE)
	supplier = models.ForeignKey(Supplier, related_name="grn_supplier", on_delete=models.SET_NULL, null=True, blank=True)
	employee = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True)
	delivery = models.CharField(max_length=100)
	...
	@property
	def total(self):
		return self.grn_list.all().aggregate(total=Sum('total'))['total']
...
class GoodsReceivedNoteList(models.Model):
	grn = models.ForeignKey(GoodsReceivedNote, related_name="grn_list", on_delete=models.CASCADE)
	description = models.CharField(max_length=256)
	unit = models.CharField(max_length=100)
	quantity = models.IntegerField()
	price = models.DecimalField(max_digits=19, decimal_places=2)
...
class PurchaseLedger(models.Model):
	...
	business = models.ForeignKey(Business, related_name="purchase_ledger", on_delete=models.CASCADE)
	supplier = models.ForeignKey(Supplier, related_name="purchase_ledger_supplier", on_delete=models.SET_NULL, null=True, blank=True)
	employee = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True)
	delivery = models.CharField(max_length=100)
	order_no = models.CharField(max_length=100)
