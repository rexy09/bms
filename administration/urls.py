...
urlpatterns = [
	...
	path('bank/registration/', views.bank_list, name='bank-list'),
	...
	path('bank/edit/<int:id>/', views.bank_edit, name='bank-edit'),
	path('bank/delete/<int:id>/', views.bank_delete, name='bank-delete'),
	path('account/edit/<int:id>/', views.account_edit, name='account-edit'),
	path('bank-account/edit/<int:id>/', views.bank_account_edit, name='bank-account-edit'),
	...
	path("stock/reports/time/", reports.stock_time, name="stock_time"),
    path("<int:d>/reports/stock/report", reports.stock_report, name="stock_report"),
